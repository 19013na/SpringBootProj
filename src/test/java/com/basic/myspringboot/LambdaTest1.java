...
public class LambdaTest1 {
    ...
    public void transformUsingStream(){
        ...
        customers.stream()  // List<MyCustomer> -> Stream<MyCustomer>
                .map(cust -> cust.getName())// Stream<MyCustomer> -> Stream<String>
                .toList() // Stream<String> -> List<String
                .forEach(System.out::println);

        // id가 103보다 큰 Customer list를 추출해라
        customers.stream()  // List<MyCustomer> -> Stream<MyCustomer>
                .filter(cust -> cust.getId() >= 103)
                .map(MyCustomer::getName)// Stream<MyCustomer> -> Stream<String>
                .toList() // Stream<String> -> List<String
                .forEach(System.out::println);
